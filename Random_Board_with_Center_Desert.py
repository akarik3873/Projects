...
class Board:
    def __init__(self):
        self.numbers = {}
        self.types = {}
        self.ports = [["Water", "Wood", "Wood", "Wood", "Water"], 
                 ["Water", "Water", "Wheat", "Wheat", "Wheat"], 
                 ["Water", "Rock", "Rock", "Rock", "Water"], 
                 ["Water", "Water", "Sheep", "Sheep", "Sheep"], 
                 ["Water", "Water", "Water", "Water", "Water"],
                 ["Water", "Water", "Brick", "Brick", "Brick"]]
        self.board = []
        for i in range(18):
            smth = Tile(i)
            self.board.append(smth)
        self.tile_type = {"Wheat": 4, "Sheep": 4, "Wood": 4, "Brick": 3, "Stone": 3}
        self.tile_types = ["Wheat", "Sheep", "Wood", "Brick", "Stone"] 
        self.tile_num = {2:1, 3:2, 4:2, 5:2, 6:2, 8:2, 9:2, 10:2, 11:2, 12:1}
        self.tile_nums = list(range(2, 7)) + list(range(8, 13))
...
# establishing the inner ring      
        for i in range(6):
            self.board[i].sides[0].tile = "Desert"
            ...
            if i == 0:
                self.board[i].sides[1].tile = self.board[5]
                self.board[i].sides[2].tile  = self.board[17]
            if i == 5:
                self.board[i].sides[5].tile = self.board[0]    
